...
cp target/classes/menu\$2.class plugin
...
cd plugin
jar cvfM CalciumSignal_.jar CalciumSignal_.class CalciumSignal_.java custom_roiManager.class custom_roiManager.java Cell.class Cell.java CellManager.class CellManager.java PeakManager.class PeakManager.java menu.class menu.java menu\$1.class menu\$2.class imageJ/plugins/*.class celldetection/*.class celldetection/Objects3D/*.class celldetection/Watershed3D/*.class plugins.config
cd ..
