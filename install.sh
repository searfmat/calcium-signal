...
cd plugin
jar cvfM CalciumSignal_.jar CalciumSignal_.class CalciumSignal_.java custom_roiManager.class custom_roiManager.java imageJ/plugins/*.class celldetection/*.class celldetection/Objects3D/*.class celldetection/Watershed3D/*.class menu.class menu.java plugins.config
cd ..
